...
batchsize=21#optimal['batch_size']
learnrate=0.0041273756281123555#optimal['learn_rate']
epochs=240#optimal['epochs']
...
model=djinn.load(model_name="reg_djinn_test")
...
model.gradient(x_test)
model.hessian(x_test)
